package com.example.a24012021094_anubhav_prac3
...
class MainActivity : AppCompatActivity() {
    ...
    fun implicitIntent(){
        findViewById<Button>(R.id.btn_browse).setOnClickListener {
            Intent(Intent.ACTION_VIEW, Uri.parse(findViewById<EditText>(R.id.editTextText3).text.toString())).also { startActivity(it) }
        }
        findViewById<Button>(R.id.btn_call).setOnClickListener {
            val number=findViewById<EditText>(R.id.editTextText4).text.toString()
